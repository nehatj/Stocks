...
class NewStock(models.Model):
    ...
    dt_created = models.DateField(null=True, blank=True)
    class Meta:
        db_table = u'new_stock'
...
class Stock(models.Model):
    ...
    pdf_link = models.CharField(max_length=120, blank=True)
    dt_posted = models.DateField(null=True, blank=True)
    contents = models.TextField(max_length=255, blank=True)
